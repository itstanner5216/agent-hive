 ...
 * - packages/opencode-pantheon/skills/[dir]/SKILL.md
 * 
 * Outputs: packages/opencode-pantheon/src/skills/registry.generated.ts
 */
...
function discoverSkillFiles(rootDir: string): string[] {
  ...
  // 1. opencode-pantheon/skills/**/SKILL.md
  const localSkillsDir = path.join(rootDir, 'packages/opencode-pantheon/skills');
...
function main() {
  // Find the monorepo root (go up from scripts/ to opencode-pantheon/ to packages/ to root/)
  ...
  const outputPath = path.join(rootDir, 'packages/opencode-pantheon/src/skills/registry.generated.ts');
