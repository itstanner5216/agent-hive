...
const TEST_DIR = "/tmp/pantheon-core-taskservice-test-" + process.pid;
...
**Files:**
- Create: \`packages/pantheon-core/src/new-module.ts\`
...
**Files:**
- Test: \`packages/pantheon-core/src/services/taskService.test.ts\`
...
**Files:**
- Modify: \`packages/opencode-pantheon/src/agents/forager.ts\`
