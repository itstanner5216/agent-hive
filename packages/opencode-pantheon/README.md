...
```bash
npm install opencode-pantheon
```

## Optional: Enable MCP Research Tools

1. Create `.opencode/mcp-servers.json` using the template:
   - From this repo: `packages/opencode-pantheon/templates/mcp-servers.json`
   - Or from npm: `node_modules/opencode-pantheon/templates/mcp-servers.json`
